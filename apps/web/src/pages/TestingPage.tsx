...
export default function TestingPage() {
  ...
  const agents = [
    { id: '1', name: 'Testing Agent', description: 'Runs the full test suite against the generated application and produces the PASS / FAIL / ERROR verdict.', status: 'completed' as const },
  ]
  ...
  return (
    <div>
      ...
      {/* Agents */}
      <AgentList agents={agents} title="Testing Agents" />
