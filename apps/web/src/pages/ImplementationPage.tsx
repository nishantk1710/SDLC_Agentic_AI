...
export default function ImplementationPage() {
  ...
  const agents = [
    { id: '1', name: 'Code Generation', description: 'Generates the initial source code from the design package.', status: 'completed' as const },
    { id: '2', name: 'Code Review', description: 'Reviews the code and identifies quality issues without modifying it.', status: 'completed' as const },
    { id: '3', name: 'Refactoring', description: 'Improves the code by applying the review suggestions.', status: 'completed' as const },
    { id: '4', name: 'Debugging', description: 'Runs the application, fixes errors, and ensures it executes successfully.', status: 'completed' as const },
    { id: '5', name: 'Unit Test Generation', description: "Creates and runs unit tests to verify the application's functionality.", status: 'completed' as const },
    { id: '6', name: 'Documentation', description: 'Generates the README, API documentation, and code documentation.', status: 'completed' as const },
    { id: '7', name: 'Security', description: 'Scans the application for vulnerabilities and generates a security report.', status: 'completed' as const },
  ]
  ...
  return (
    <div>
      ...
      {/* Agents */}
      <AgentList agents={agents} title="Implementation Agents" />
